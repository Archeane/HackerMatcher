...
#db = client['test']
#client = MongoClient("mongodb://admin:qwerty123@ds227352.mlab.com:27352/?authSource=admin")
#db = client['hackermatcher']
connection = MongoClient('ds227352.mlab.com', 27352)
db = connection['hackermatcher']
db.authenticate("admin", "qwerty123")
...
def calculateallscores(currentHacker, allHackers):
    ...
    for hacker in allHackers:
        ...
        if similiarity != 0:
            temp = [str(hacker['_id']), similiarity]
